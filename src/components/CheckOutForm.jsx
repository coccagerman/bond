...
////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    function handleSubmit (e) {
        ...
        let dniValidation = validateInput(regex.dni,dniInputValue)
        ...
        if (nameValidation === false) {
            setCheckOutFormErrorMessage (<p className="checkOutErrorMessage">Por favor corrobore el nombre ingresado.</p>)
        } else if (dniValidation === false) {
            setCheckOutFormErrorMessage (<p className="checkOutErrorMessage">Por favor corrobore el DNI ingresado.</p>)
        } else if (telephoneValidation === false) {
            setCheckOutFormErrorMessage (<p className="checkOutErrorMessage">Por favor corrobore el teléfono ingresado.</p>)
        } else if (emailValidation === false) {
            setCheckOutFormErrorMessage (<p className="checkOutErrorMessage">Por favor corrobore el email ingresado.</p>)
        } else {
        ...
        <div className="checkOutform-container">
            <form action="" method="get" className={checkOutformClassName}>
                ...
                <article className="formInput">
                    ...
                    <input id="dni" type="text" className="textBox" onChange={e => setDniInputValue(e.target.value)}/>
                </article>
