...
function Preloader ({setSectionShown, preloadNextSection}) {
    ...
    return (
        <animated.section style={preloaderAnimationProps} className="preloaderSection">
            <div className="preloaderContainer">
                <div class="loading-bar">
                    <svg class="airplane" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" width="151.18" height="99.44" viewBox="0 0 301.18 99.44">
                        <g>
